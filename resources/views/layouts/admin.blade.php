						...
						<ul class="list-unstyled components" id="accordion">
							...
							<li>
								...
								<ul class="collapse list-unstyled" id="homepage" data-parent="#accordion">
                                    ...
                                    <li>
                                    	<a href="{{ route('admin-gs-banner') }}"><span>Banner</span></a>
                                    </li>

                                    <li>
                                    	<a href="{{ route('admin-sl-index') }}"><span>Banner Sliders</span></a>
                                    </li>
                                    <li>
                                    	<a href="{{ route('admin-service-index') }}"><span>Features</span></a>
                                    </li>
                                    ...
                                    <li>
                                    	<a href="{{ route('admin-ps-video') }}"><span>Video Informations</span></a>
                                    </li>
                                    <li>
                                    	<a href="{{ route('admin-feature-index') }}"><span>Service Section</span></a>
                                    </li>
                                    <li>
                                    	<a href="{{ route('admin-portfolio-index') }}"><span>Portfolio Section</span></a>
                                    </li>
                                    <li>
                                    	<a href="{{ route('admin-vpresentation-index') }}"><span>Video Presentation Section</span></a>
                                    </li>                                    
                                    <li>
