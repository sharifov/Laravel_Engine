...
<div class="content-area">
              ...
              <div class="add-product-content">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-6">
                  <label class="control-label" for="slider">Banner Sliders *</label>
                  ...
                  <div class="col-sm-6 ">
                  <label class="control-label" for="service">Features *</label>
                    <label class="switch float-right">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-6">
                  <label class="control-label" for="small_banner">Video Informations *</label>
                    <label class="switch float-right">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-6">
                  <label class="control-label" for="best">Service Section *</label>
                    <label class="switch float-right">
                  ...
                  <div class="col-sm-6">
                  <label class="control-label" for="top_rated">Portfolio Section *</label>
                    <label class="switch float-right">
