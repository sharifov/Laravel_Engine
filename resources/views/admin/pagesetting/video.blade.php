...
@section('content')
            ...
            <div class="content-area">
              <div class="mr-breadcrumb">
                <div class="row">
                  <div class="col-lg-12">
                      <h4 class="heading">Video Informations </h4>
                      <ul class="links">
                        <li>
                        ...
                        <li>
                          <a href="{{ route('admin-ps-video') }}">Video Informations </a>
                        </li>
                      </ul>
                  </div>
                </div>
                    ...
                    <div class="product-description">
                      ...
                      <form id="geniusform" action="{{ route('admin-ps-update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                          <textarea class="input-field" name="video_link" placeholder="Youtube Link" required="" rows="5"> {{$data->video_link}} </textarea>
                        ...
                        <div class="row">
                          <div class="col-lg-4">
                            <div class="left-area">
                                <h4 class="heading">Video Image *</h4>
                            </div>
                          </div>
                          <div class="col-lg-7">
                        ...
                        <div class="row">
                          <div class="col-lg-4">
                            <div class="left-area">
                                <h4 class="heading">Video Background *</h4>
                            </div>
                          </div>
                          <div class="col-lg-7">
                            <div class="img-upload full-width-img">
