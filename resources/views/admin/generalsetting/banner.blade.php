                ...
                <div class="row">
                  <div class="col-lg-12">
                      ...
                      <ul class="links">
                        ...
                        <li>
                          <a href="{{ route('admin-gs-banner') }}">Banner</a>
                        </li>
                      </ul>
                  </div>
                </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <div class="img-upload full-width-img">
                                <div id="image-preview" class="img-preview" style="background: url({{ $gs->banner ? asset('assets/images/'.$gs->banner):asset('assets/images/noimage.png') }});">
