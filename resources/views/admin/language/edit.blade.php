                    ...
                    <div class="product-description">
                      ...
                      <hr>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang1" placeholder="Follow Us" required="" value="{{ $lang->lang1 }}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang3" placeholder="Services" required="" value="{{ $lang->lang3 }}">
                          </div>
                        </div>
